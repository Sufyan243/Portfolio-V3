...
const marqueeItems = [
  ...
  "React", "Next.js", "PostgreSQL", "Docker", "OpenAI API", "LangChain",
  "Redis", "MySQL", "Tailwind CSS", "TypeScript",
];

const testimonials = [
  {
    av: "AK",
    cls: "border-[rgba(168,255,120,0.2)] bg-[rgba(168,255,120,0.05)] text-accent",
    text: "Sufyan delivered our backend system in record time. His attention to architecture and code quality was outstanding throughout the project.",
    name: "Ahmed Khan",
    role: "CTO, TechStartup",
  },
  {
    av: "SR",
    cls: "border-[rgba(120,216,255,0.2)] bg-[rgba(120,216,255,0.05)] text-[#78d8ff]",
    text: "Incredible depth of knowledge in AI integration. The document assistant he built handles thousands of queries and still feels snappy.",
    name: "Sara Raza",
    role: "Product Manager, DataCo",
  },
  {
    av: "MJ",
    cls: "border-[rgba(255,168,100,0.2)] bg-[rgba(255,168,100,0.05)] text-[#ffa864]",
    text: "Clean code, on budget, and genuinely enjoyable to work with. The expense tracking platform exceeded all our expectations.",
...
const faqs = [
  {
    ...
    a: "Java, JavaScript, PHP, Python, and C# on the backend. React and Node.js on the frontend. MySQL for databases. I work across the full stack but my focus is on backend logic, APIs, and clean system design.",
  },
  {
    q: "Do you work on AI and machine learning projects?",
    a: "Yes — I've built Neuromap, a JavaFX desktop app with real-time facial emotion detection using OpenCV and a FER+ ONNX model, and an AI chatbot with multi-turn context. I integrate AI capabilities into practical systems rather than building models from scratch.",
  },
  {
    q: "What kind of projects do you build?",
    a: "Full-stack applications — from backend logic and REST APIs to clean, usable frontends. Examples include an exam seating optimizer using graph coloring algorithms, a pedagogical Python debugger with Docker sandboxing, a personal finance tracker, and a SaaS landing page template.",
  },
  {
  ...
  return (
    <>
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-10 pt-24 pb-16 w-full">
          ...
          >
            ...
            <h1 className="font-display text-[clamp(2.2rem,5vw,4.5rem)] font-bold tracking-[-0.04em] leading-[1.05] mb-8">
              I&apos;m a backend<br />
              <span className="stroke-accent">engineer</span><br />
            ...
            <div className="flex items-end justify-between gap-12 flex-wrap mt-8">
              <p className="text-[15px] text-fg2 max-w-[360px] leading-[1.8] border-l border-border2 pl-6">
                Specializing in scalable backend systems, AI integrations, and full-stack applications — from database architecture to polished interfaces.
              </p>
        ...
        <Container>
          <div className="flex justify-between items-end flex-wrap gap-4 mb-12">
            ...
            <p className="text-fg2 text-[14px] max-w-[300px] leading-[1.75]">
              Backend systems, AI tools, and full-stack applications.
            </p>
          </div>

          {/* Terra Debugger — hero project, full width */}
          {terraDebugger && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[1px] bg-border border border-border border-t-0">
      ...
      <SectionWrapper id="testimonials">
        <Container>
          <p className="text-[11px] tracking-[0.14em] uppercase text-fg3 mb-3">What clients say</p>
          <h2 className="font-display text-[clamp(2rem,4vw,3.2rem)] font-bold tracking-[-0.04em] leading-[1.05] mb-12 text-fg">
            Customer testimonials
          </h2>
          <div className="grid md:grid-cols-3 gap-[1px] bg-border border border-border">
            {testimonials.map((t) => (
              <div key={t.name} className="group relative bg-surface hover:bg-bg2 p-9 transition-colors duration-200">
                <div className="font-display text-5xl leading-[0.8] text-accent mb-5 opacity-60">&ldquo;</div>
                <p className="text-[13px] text-fg2 leading-[1.85] mb-7 italic">{t.text}</p>
                <div className="flex items-center gap-3">
                  <div className={`w-[38px] h-[38px] rounded-full flex items-center justify-center font-display text-[13px] font-bold flex-shrink-0 border ${t.cls}`}>
                    {t.av}
                  </div>
                  <div>
                    <div className="font-display text-[13px] font-semibold tracking-[-0.01em] text-fg">{t.name}</div>
                    <div className="text-[11px] text-fg3 mt-[2px] tracking-[0.04em]">{t.role}</div>
                  </div>
                </div>
                <div className="neon-border">
                  <span className="nb-t" /><span className="nb-b" />
